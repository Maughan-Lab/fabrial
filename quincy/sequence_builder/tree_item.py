...
if TYPE_CHECKING:
    from ..classes import AbstractBackgroundProcess, AbstractForegroundProcess
...
class TreeItem:
    ...
    def from_dict(
        ...
        widget = widget_type.from_dict(item_as_dict[WIDGET_DATA])
        ...
        for child_item_as_dict in item_as_dict[CHILDREN]:
            child_widget_type = ItemType.from_name(child_item_as_dict[TYPE]).value
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        item_as_dict[TYPE] = ItemType.from_widget(self.linked_widget).name
