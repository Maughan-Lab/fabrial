...
SettingNames = Files.ApplicationSettings.Gamry
...
class GamrySettingsTab(SettingsDescriptionWidget):
    ...
    def __init__(self):
        ...
        self.set_description_from_file(
            Files.ApplicationSettings.Gamry.FOLDER,
            Files.ApplicationSettings.Gamry.DESCRIPTION_FILENAME,
        ...
        self.default_location_button = Button(
            "Default Location",
            lambda: self.gamry_location_label.label().setText(Files.DEFAULT_GAMRY_LOCATION),
        )
        ...
        if self.enabled_checkbox.isChecked() and not GAMRY.is_valid():
            if YesCancelDialog(
                ...
                (
                    ...
                    f"{Files.APPLICATION_NAME} will launch without Gamry features. You may change "
    ...
    def choose_gamry_location(self):
        ...
        filepath = QFileDialog.getOpenFileName(
            ...
            os.path.dirname(Files.DEFAULT_GAMRY_LOCATION),
            "Executables (*.exe)",
        )[0]
        if filepath != "":
    ...
    def save_on_close(self):
        ...
        with open(Files.ApplicationSettings.Gamry.SETTINGS_FILE, "w") as f:
